...
import { getCardProps, getRestoredItems, getFullScreenCard } from '../../../src/grid/gridProps'
// import { useSnackbar } from 'notistack';
import { GridInterface } from '../../../src/grid/GridInterface'
...
function Grid(props) {
    ...
    function saveGridElements(gridId, identifier, userId, gridElements, token) {
    ...
    function fetchGridElements(userId, token) {
        const headers = {
            headers: {
    ...
    function deleteGrid(gridId, token) {
        const headers = {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': "Bearer " + token
    ...
    function deactivateGrid(userId, identifier, token) {
        const headers = {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': "Bearer " + token
    ...
    function fetchTickerData(ticker, token) {
